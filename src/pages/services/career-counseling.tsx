...
>
  ...
  <span>Counselor Login</span>
      ...
      >
        <h2 className="text-3xl font-bold mb-4 text-[#7655b7]">
        ...
        <p className="mt-4 text-sm italic text-gray-500">
          No cost. No pressure. Just clarity and care from someone who’s been there.
        </p>
      </section>

      {/* Section: Sruti's Profile */}
      <section className="bg-white shadow-xl rounded-2xl p-8 border border-gray-200">
        <h2 className="text-2xl font-bold mb-4 text-[#7655b7]">Meet Sruti – Your Career Coach</h2>
        <p className="mb-3">
          Sruti is a passionate and experienced career counselor with over <strong>7+ years</strong> in guiding students toward the right academic and professional paths. With a background in psychology and career development, she’s known for her empathetic approach and data-driven guidance.
        </p>
      ...
      {/* Section: FAQs */}
      <section className="bg-white shadow-xl rounded-2xl p-8 border border-gray-200">
        <h2 className="text-2xl font-bold mb-4 text-[#7655b7]">Frequently Asked Questions</h2>
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold">1. Is the session really free?</h3>
            <p className="text-gray-700">
              Yes! The 15-minute session is 100% free with no strings attached. It’s meant to give you an idea of what full counseling looks like.
            </p>
          </div>
          <div>
            <h3 className="font-semibold">2. Do I need to prepare anything before the session?</h3>
            <p className="text-gray-700">
              Not at all. Just come with an open mind and a willingness to explore possibilities.
            </p>
          </div>
          <div>
            <h3 className="font-semibold">3. Can my child also attend the session?</h3>
            <p className="text-gray-700">
              Absolutely. In fact, we recommend the student be present along with the parent for best results.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white shadow-xl rounded-2xl p-8 border border-gray-200">
        <h2 className="text-2xl font-bold mb-6 text-[#7655b7]">What Parents Say</h2>
        <div className="space-y-4">
          <blockquote className="border-l-4 pl-4 border-[#7655b7] italic">
            “Sruti’s advice was the wake-up call we needed. We finally saw where our son’s strengths truly lie. Thank you for your calm, clear guidance.”
            <div className="mt-2 font-semibold">– Ananya, Parent of Class 12 Student</div>
          </blockquote>
          <blockquote className="border-l-4 pl-4 border-[#7655b7] italic">
            “I wish we had found her earlier. The free session opened our eyes to career options we never considered.”
            <div className="mt-2 font-semibold">– Ravi Kumar, Parent from Hyderabad</div>
          </blockquote>
        </div>
      </section>
      ...
      >
        <h2 className="text-2xl font-bold mb-4 text-[#7655b7]">Ready to Discover the Right Path?</h2>
        <p className="text-lg mb-6">
          Book your <strong>free 15-minute career counseling session</strong> now and get expert guidance from Sruti.
        </p>
        <button
