...
//             'template_1oe2l9b', // Replace with your EmailJS template ID
//             {
...
// export default Contactmail;import React, { useState } from 'react';
import emailjs from '@emailjs/browser';
import styles from './contactmail.module.css';
...
const Contactmail: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        emailjs.send(
            'service_2fjmap8',      // Your EmailJS service ID
            'template_1oe2l9b',     // Your EmailJS template ID
            templateParams,
            'u77ACP1YPy4znyDqR'     // Your EmailJS public key
        )
        .then((response) => {
            console.log('SUCCESS!', response.status, response.text);
            alert('Message sent successfully!');
